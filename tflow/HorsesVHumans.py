...
def solution_model():
    ...
    train_generator = train_datagen.flow_from_directory(
        'tmp/horse-or-human/', batch_size=32,
        class_mode='binary', target_size=(300, 300)
        )

    validation_generator = validation_datagen.flow_from_directory(
        'tmp/validation-horse-or-human/', batch_size=32,
        class_mode='binary', target_size=(300, 300)
        )
...
if __name__ == '__main__':
    ...
    #model = tf.keras.models.load_model('D:/Downloads/category3.h5')
    model.save("D:/Downloads/mymodel1.h5")